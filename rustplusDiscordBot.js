...
rustplus.on("disconnected", () => {
    ...
    if (connected) {
        ...
        Tools.print("ATTENTION", "Rust+ Bot lost connection to the rust server... " +
    ...
    if ((reconnectAttempts === parseInt(config.general.reconnectAttempts)) &&
        ...
        Tools.print("Reconnection Failed", "Rust+ Bot failed to reconnect to the rust server, exiting...", channel);
